...
const { extractPublicDesign } = require('../checks/arch-design-parser');
const { extractIdentifiers } = require('../checks/naming-utils');

describe('arch-design-parser.extractPublicDesign', () => {
  it('should extract naming convention from ARCHITECTURE.md', () => {
    ...
    const design = extractPublicDesign(content);
...
describe('naming-utils.extractIdentifiers', () => {
  ...
  it('should return empty when no identifiers', () => {
    const ids = extractIdentifiers('# Just a heading');
...
describe('public-design-compliance full check', () => {
  /** @type {string} */
  let tmpDir;
