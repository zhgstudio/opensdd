...
| File | Scope | Purpose |
|------|-------|---------|
| `AGENTS.md` (root) | OpenSDD skill development | Constraints for **developing the opensdd skill itself** — resolved design decisions, project conventions |
| `docs/AGENTS.md` (downstream project) | Consumer project | Entry guide for the **coding phase** — generated by OpenSDD stages, locked by human, auto-loaded by AI agents |
